...
describe UsersController do
  ...
  describe "POST 'create'" do
    ...
    describe "failure" do
      ...
      it "should erase the password fields" do
        post :create, :user => @attr.merge(:password => 'foo', :password_confirmation => 'foo')
  ...
  describe "GET 'edit'" do
    ...
    it "should have a gravatar link" do
      get :edit, :id => @user
      link = 'http://gravatar.com/emails'
      response.should have_selector("a", :href => link, :content => 'change')
    end
  end
  ...
  describe "GET 'index'" do
    describe "for non-signed-in users" do
      it "should deny access and redirect to the signin page" do
        get 'index'
        response.should redirect_to signin_path
